...
def best_fit_distribution(data, bins=200, ax=None):
    ...
    for distribution in DISTRIBUTIONS:
        os.system('clear')
        progress = num / len(DISTRIBUTIONS)
        print('progress : ' + str(progress * 100) + "% " + distribution.name)
        num += 1
...
headers = ['dbn_nez', 'dbe_nez', 'dbz_nez', 'dbn_geo', 'dbe_geo', 'dbz_geo']
# headers = ['dbn_nez']

full_data = pd.read_csv('data/AND_day.csv', sep=',', encoding='utf-8', header=0)
